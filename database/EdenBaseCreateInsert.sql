...
INSERT INTO Reference VALUES
    ...
    (190,'ArchiveFonctional','Shot Timelapse still fonctunional but not used anymore'),
    (191,'Archive','Shot Timelapse not used anymore'),
    (192,'NeedCorrection','Shot Timelapse that cannot be used before changes'),
    (193,'NeedVerification','Shot Timelapse that should be tested and verified'),
    (194,'Buggy','Some bugs were spotted during the use of this timelapse'),
    (195,'Corrected','Shot Timelapse that have been corrected once'),
    (196,'Duplicate','Duplicate of another timelapse'),
    ...
    (401,'HardwareGh','The data sample is done only from the hardware sensors'),
    (402,'Open','The data sample is done from open data'),
    (403,'OpenHard','The data sample is done from open data and hardware sensors'),
    (404,'PartialData','The data sample is not complete'),
...
INSERT INTO Plant (PName, PDescription, LowTemp, HighTemp) VALUES
    ...
    ('Chayote','Choko, Chayote squash, christophene, chouchou, mirliton. Chokos can be peeled and chopped to use in stews, soup or as a stir fry vegetable. Cooked or raw, it has a very mild flavour and is commonly served with seasonings, salt, butter and pepper or in a dish with other vegetables or flavourings. It can also be boiled, stuffed, mashed or pickled Harvest in approximately 17 weeks. Best when fruit is light green and not more than 6cm long. Compatible with : Cucumbers',16,30),
    ...
    ('Mulberry','Mulberries are fast-growing when young, and can grow to 24m tall. The leaves are alternately arranged, simple, and often lobed and serrated on the margin.',NULL,NULL),
    ...
    ('Oak','Oak wood has a density of about 0.75 g by cm3 creating great strength and hardness. The wood is very resistant to insect and fungal attack because of its high tannin content. It also has very appealing grain markings, particularly when quartersawn. Oak planking was common on high status Viking longships in the 9th and 10th centuries.',-40,NULL),
    ...
    ('Zucchini','Courgette, Marrow, Summer squash. Zucchini are best picked or cut off the stem at about 15cm.Pick frequently to keep the plant producing new flowers. Harvest in 6-9 weeks. Cut the fruit often to keep producing. Compatible with : Corn, beans, nasturtiums, parsley, Silverbeet, Tomatoes',21,35);
